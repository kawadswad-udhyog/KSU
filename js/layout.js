...
function initBackToTop() {
    ...
    if (!backToTopBtn) {
        ...
        backToTopBtn.className = 'fixed bottom-6 right-6 z-40 p-3 bg-[#4E342E] text-[#E6B800] rounded-full shadow-lg border border-[#E6B800]/30 opacity-0 pointer-events-none transition-all duration-300 hover:bg-[#E6B800] hover:text-[#4E342E] focus:outline-none focus-visible:ring-2 focus-visible:ring-[#E6B800]';
